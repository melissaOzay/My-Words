...
class HomeFragment : Fragment() {
    ...
    private val recyclerViewAdapter by lazy {
        HomeAdapter(listener = object : HomeAdapter.HomeAdapterListener {
            ...
            override fun deleteFavorite(entity: WordyEntity,position: Int) {
                viewModel.deleteWordy(position)
            }
    ...
    private fun loadData() {
        viewModel.wordyListInfo.observe(this) {
            recyclerViewAdapter.setListData(it as List<WordyEntity>)
        }
